//! Small canonical codec used by the Tier-0 wire formats.
//!
//! All integers are big endian and variable data is `u32` length-prefixed.
//! Decoders apply limits before allocation and reject trailing bytes.
...
impl<'a> Reader<'a> {
    ...
    fn take(&mut self, length: usize) -> Result<&'a [u8]> {
        let end = self
            .offset
            .checked_add(length)
            .ok_or(AttestError::LimitExceeded)?;
