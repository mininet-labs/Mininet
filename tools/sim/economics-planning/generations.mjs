...
export function forecast(input={}){
  ...
  for(let i=0;i<rows.length;i++){
    ...
    r.targetNetIssuanceMINI=initialPrice>0?(i?r.targetTotalMINI-previous.targetTotalMINI:0):null;
    r.targetNetIssuancePct=initialPrice>0?(i?r.targetNetIssuanceMINI/previous.targetTotalMINI*100:0):null;
